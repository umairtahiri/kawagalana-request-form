...
const Page27 = (props) => {
  ...
  const companyFounders = useSelector((state) => {
    return state?.app?.companyFounders;
  });
  ...
  useEffect(() => {
    if (companyFounders && companyFounders !== "") {
      setShowButton(true);
    } else {
      setShowButton(false);
    }
      ...
      <div style={centerAlignStyle}>
        <div className="page-number">
          <div className="page-number-style">
            <div style={{ marginRight: "5px" }}> 27</div>{" "}
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) => dispatch(act.setCompanyFounders(e.target.value))}
            id="url-input"
          />
